...
{
    public class EasyMode : IVisitor
    {
        private int Count = Constants.EASY_OBSTACLE_COUNT;
        ...
        public void VisitStatic(StaticObstacle obj)
        {
            ...
            innerCorners = innerCorners.Append(new Coordinate(Constants.CANVAS_WIDTH - 100, 50)).ToArray();
            innerCorners = innerCorners.Append(new Coordinate(50, Constants.CANVAS_HEIGHT - 100)).ToArray();
            innerCorners = innerCorners.Append(new Coordinate(Constants.CANVAS_WIDTH - 100, Constants.CANVAS_HEIGHT - 100)).ToArray();
